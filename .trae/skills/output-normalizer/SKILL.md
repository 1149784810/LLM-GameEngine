...
```
projects/
└── [项目名称]/              # 例如: projects/连连看/, projects/超级马里奥/
    ├── docs/                # 策划文档
    │   ├── 系统策划/
    │   ├── 数值策划/
    │   ├── 关卡策划/
...
- ✅ 正确: `projects/连连看/docs/系统策划/游戏设计.md`
...
项目名称？ → 连连看
文件类型？ → 策划文档
推荐路径：projects/连连看/docs/系统策划/
```

**输出**:
```
请将策划文档输出到：
projects/连连看/docs/系统策划/游戏设计.md
```
...
| 场景 | 推荐目录 | 示例路径 |
|------|---------|---------|
| 游戏开发 | `projects/[项目名称]/` | `projects/连连看/src/game.js` |
| 应用开发 | `projects/[项目名称]/` | `projects/任务管理/src/app.py` |
...
| 错误做法 | 问题 | 正确做法 |
|---------|------|---------|
| `C:\Users\Desktop\游戏设计.md` | 散落在系统目录 | `projects/我的游戏/docs/策划/游戏设计.md` |
| `temp/重要项目/` | 重要文件放在临时目录 | `projects/重要项目/` |
