...
| L0-003 | #5, #11, #12 | 流程问题 | 通用 | QA测试, 审核, 功能失效 | 0 | - | 检查QA是否实际点击了每个按钮，审核是否流于形式 |
...
| QA测试 | L0-003 | #5, #11, #12 | 测试覆盖不足，审核流于形式 |
| 审核 | L0-003 | #5, #11, #12 | 策划审核、程序审核不全面 |
| 功能失效 | L0-003 | #5, #11, #12 | 功能实际不可用但审核通过 |
